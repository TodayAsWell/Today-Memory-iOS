...
class CameraViewController: UIViewController, AVCapturePhotoCaptureDelegate {
    ...
    // 상단 툴 바
    var settingToolbar: UIToolbar! // 화면 비율 버튼이 있는 툴바
    var settingToolbarHeight: NSLayoutConstraint! // 셋업 툴바 height 셋업
    var moreView: UIView! // 더보기 뷰(활성화/비활성화)
    var screenRatioBarButtonItem: UIBarButtonItem! // 스크린 비율을 위한 버튼 (1:1, 3:4, 9:16)
    var switchButton: UIButton! // 카메라 전환 버튼
    var timerButton: UIButton! // 타이머, 더보기에 있는 버튼 이미지
    var timeLeft: UILabel! // 타이머, 동작할 때 화면중앙에 남은 시간 안내
    var flashButton: UIButton! // 플래시 on/off 버튼
    var touchCaptureButton: UIButton! // 터치촬영 on/off 버튼
    var continuousCaptureButton: UIButton!// 연속촬영 버튼
    var blindView: UIView!
    
    // 화면 중앙에 위치한 기능들
    var previewView: PreviewView!
    var previewViewHeight: NSLayoutConstraint!
    var gridviewView: GridView!
    var gridButton: UIButton! // 그리드 버튼
    var gridViewHeight: NSLayoutConstraint!
    var gridH1: NSLayoutConstraint!
    var gridH2: NSLayoutConstraint!
    var gridV1: NSLayoutConstraint!
    var gridV2: NSLayoutConstraint!
    var layoutView: UIView! // 레이아웃 뷰
    var skyShotOuter: UIImageView! // 항공샷 기준점 (기준각도)
    var skyShotInner: UIImageView! // 항공샷 인디케이터(각도 표시기)

    var layoutViewHeight: NSLayoutConstraint!
    
    // 하단 툴 바
    var cameraToolsView: UIView! // 화면 하단의 툴 바
    var photosButton: UIButton! // 사진촬영 버튼
    var horizonIndicator: UIView! // 수평계(회전할 superview)
    var captureButtonInner: UIImageView! // 캡쳐버튼 회전하는 객체
    var captureButtonOuter: UIImageView! // 캡쳐버튼 테두리
    var horizonIndicatorInner: UIImageView! // 회전하는 객체
    var horizonIndicatorOuter: UIImageView! // 수평 100%
    var anglePinStatus: UIImageView! // 각도고정핀 활성화 상태표시
    var anglePin: UIView! // 각도 고정핀 회전을 위한 프로퍼티
